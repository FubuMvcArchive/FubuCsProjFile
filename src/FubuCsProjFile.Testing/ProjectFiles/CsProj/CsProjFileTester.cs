...
namespace FubuCsProjFile.Testing.ProjectFiles.CsProj
{
    [TestFixture]
    public class CsProjFileTester
    {
        ...
        {
            var project = ProjectCreator.CreateAtSolutionDirectory("Foo", "myproj", ProjectType.CsProj);
        ...
        {
            var project = ProjectCreator.CreateAtLocation("Foo.AssemblyName.csproj", "Foo.AssemblyName");
            project.ProjectGuid.ShouldNotEqual(Guid.Empty);
        }
        ...
        {
            var project = ProjectCreator.CreateAtSolutionDirectory("Goofy", "Directory", ProjectType.CsProj);
